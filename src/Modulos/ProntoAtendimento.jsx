...
export default function ProntoAtendimento() {
  ...
  const chartData = [
    { title: 'Emergencia', percentage: 12, color: '#4b3f72', description: 'Descrição do gráfico de atendimento', id: 'Atendimentos___Por_Escala_Manchester' },
    { title: 'Emergencia', percentage: 15, color: '#417b5a', description: 'Descrição do gráfico de ocupação', id: 'HCR____Ocupação' },
    { title: 'Emergencia', percentage: 20, color: '#d0ceba', description: 'Descrição do gráfico de recuperação', id: 'recuperacao' },
    { title: 'Emergencia', percentage: 18, color: '#ffffff', description: 'Descrição do gráfico financeiro', id: 'financeiro' },
    { title: 'Emergencia', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Emergencia', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Emergencia', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Emergencia', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Emergencia', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
