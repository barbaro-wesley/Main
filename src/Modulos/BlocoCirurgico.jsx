...
export default function BlocoCirurgico() {
    ...
    window.visualize(
      ...
      function (v) {
        v(containerId).adhocView({
          resource: `/adhoc/HCR__Marau_/Cirurgias/${chartId}`,
  ...
  const chartData = [
    { title: 'Bloco', percentage: 12, color: '#4b3f72', description: 'Descrição do gráfico de atendimento', id: 'Atendimentos___Por_Escala_Manchester' },
    { title: 'Bloco', percentage: 15, color: '#417b5a', description: 'Descrição do gráfico de ocupação', id: 'HCR____Ocupação' },
    { title: 'Bloco', percentage: 20, color: '#d0ceba', description: 'Descrição do gráfico de recuperação', id: 'recuperacao' },
    { title: 'Bloco', percentage: 18, color: '#ffffff', description: 'Descrição do gráfico financeiro', id: 'HCR___Cirurgias_Por_Cirurgião_Complexidade___Mensal' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'HCR___Cirurgias_Por_Convenios___Mensal___Gráfico' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'HCR___Cirurgias_Por_Localidade_Complexidade___Mensal' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Bloco', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
