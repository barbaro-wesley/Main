...
export default function Faturamento() {
  ...
  const chartData = [
    { title: 'faturamento', percentage: 12, color: '#4b3f72', description: 'Descrição do gráfico de atendimento', id: 'Atendimentos___Por_Escala_Manchester' },
    { title: 'faturamento', percentage: 15, color: '#417b5a', description: 'Descrição do gráfico de ocupação', id: 'HCR____Ocupação' },
    { title: 'faturamento', percentage: 20, color: '#d0ceba', description: 'Descrição do gráfico de recuperação', id: 'Atendimentos___Por_Profissional' },
    { title: 'faturamento', percentage: 18, color: '#ffffff', description: 'Descrição do gráfico financeiro', id: 'Atendimentos___Total_por_Faixa_de_Horário' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'Atendimentos___Por_Profissional' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'Atendimentos___Adulto_por_Dia_da_Semana' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'HCR___Tempo_médio_de_permanência_do_paciente_internado__por_setor_' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'faturamento', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
