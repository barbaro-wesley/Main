...
export default function Suprimentos() {
  ...
  const chartData = [
    { title: 'Suprimentos', percentage: 12, color: '#4b3f72', description: 'Descrição do gráfico de atendimento', id: 'Atendimentos___Por_Escala_Manchester' },
    { title: 'Suprimentos', percentage: 15, color: '#417b5a', description: 'Descrição do gráfico de ocupação', id: 'HCR____Ocupação' },
    { title: 'Suprimentos', percentage: 20, color: '#d0ceba', description: 'Descrição do gráfico de recuperação', id: 'recuperacao' },
    { title: 'Suprimentos', percentage: 18, color: '#ffffff', description: 'Descrição do gráfico financeiro', id: 'financeiro' },
    { title: 'Suprimentos', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Suprimentos', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Suprimentos', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Suprimentos', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
    { title: 'Suprimentos', percentage: 25, color: '#ffffff', description: 'Descrição do gráfico de desempenho', id: 'desempenho' },
